...
class ContentProvider {
  ...
  List<ContentDataStructure> process() {
    ...
    allContent.add(ContentDataStructure('https://play.google.com/store/apps/details?id=net.geekstools.floatshort.PRO',
        ...
        'https://www.youtube.com/watch?v=nk8uHMq8-Yc&list=PLTs5v2BrWyWkStqKF9_9R3ewgR3AifcZO', 'https://twitter.com/GeeksEmpire', 'https://facebook.com/FloatingMultitasking'));
    ...
    allContent.add(ContentDataStructure('https://GeeksEmpire.co/Arwen',
        ...
        'https://www.youtube.com/@GeeksEmpireCo', 'https://twitter.com/GeeksEmpire', 'https://facebook.com/GeeksEmpire'));
